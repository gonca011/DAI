...
public class ListaPromocoes {
    ...
    public int calcularNumPromocoesAtivas(Date dataAtual){
    ...
    public int calcularNumPromocoesValidas(double km, int viagens, String origem, String destino, Date dataAtual){
    ...
    public String listarPromocoesAtivas(Date dataAtual){
    ...
    public String listarPromocoesValidas(double km, int viagens, String origem, String destino, Date dataAtual){

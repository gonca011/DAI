...
public class Promocao {
    ...
    public Promocao(String descricao, int moedasQueAtribui, LocalDate dataInicioPromocao, LocalDate dataFimPromocao, double condicoesKmPercorridos, int condicoesViagensRealizadas, String condicoesOrigem, String condicoesDestino) {
    ...
    public boolean estaAtiva(LocalDate dataAtual) {
        return dataAtual.isAfter(dataInicioPromocao) && dataAtual.isBefore(dataFimPromocao);
    }
    ...
    public String toString() {
        return "Promoções:" + descricao + ", Atribui " + moedasQueAtribui + " Moedas, Desde " + dataInicioPromocao + " Até " + dataFimPromocao + " , Tem de ter " + condicoesKmPercorridos + " Km percorridos na TUB e " + condicoesViagensRealizadas + " viagens realizadas.";
    }
